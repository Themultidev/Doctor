...
const Hero = ()=>{
    return(
        <>
        <div className="pb-5">
            <div className="flex flex-col  lg:flex-row lg:gap-8  p-4 w-full  text-gray-800 bg-gray-100">
                <div className="flex flex-col    md:min-w-2xl ">
                    
                    <Navbar/>

                    <div className="flex flex-col items-center justify-center py-20 md:py-35 lg:py-50 md:max-w-3xl ">
                        <div className="md:max-w-2xl "><h1 className="text-6xl text-center md:text-9xl  lg:text-left font-mono  ">Intimacy Empower</h1></div>
                ...
                <div className="w-full md:flex md:space-x-5 lg:flex lg:flex-col">
                    <div className="">
                        <img 
                        src="heroimg.jpeg" 
                        alt="hero image" className="  object-cover md:h-100 lg:h-full  lg:object-cover"/>
                    </div>
                    <div>
